...
// types
import { UserType, AuthContextType, ContextProps, LoginType, RegisterType } from "./models";
...
export const AuthProvider = ({ children }: ContextProps) => {
  ...
  let [user, setUser] = useState(() => {
    return localStorage.getItem("authToken") ? jwtDecode(localStorage.getItem("authToken")!) as UserType : null
  });
