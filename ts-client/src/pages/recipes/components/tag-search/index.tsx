...
// types
import { TagSearchProps } from "../../models";
import { IconCircleMinus } from "@tabler/icons-react";

export const TagSearch = ({ selectedTags, setSelectedTags }: TagSearchProps) => {

  const [name, setName] = useState("")

  const { data } = useTagSearch({ name, selectedTags });
  ...
  const handleRemoveTag = ({ name }: { name: string }) => {
