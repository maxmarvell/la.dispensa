...
import { IterationProps, UpdateIngredientProps } from "../../../@types/test-kitchen";
...
const Field = ({ data, setNodes, setCurrentIngredients, setSelectOptions }: UpdateIngredientProps) => {
  ...
  const [ingredient, setIngredient] = useState<IngredientType>(unit ? data : rest);
...
export const ModifyIngredients = ({ iteration, setNodes }: IterationProps) => {
  ...
  const [selectOptions, setSelectOptions] = useState<IngredientType[]>(iteration.ingredients);

  // Set the selected option
  const [currentIngredients, setCurrentIngredients] = useState<IngredientType[]>([])
