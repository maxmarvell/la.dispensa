...
// types
import { CreateInstructionProps, NewInstructionFieldProps } from "../../../@types/test-kitchen";
import { AuthContextType, SocketContextType } from "../../../@types/context";
import { InstructionInput } from "../../../@types/preparations";
import { TimeAndTemperatureInput } from "../../../@types/preparations";

const CREATE_INSTRUCTION_CHANNEL = import.meta.env.VITE_CREATE_INSTRUCTION_CHANNEL

const Field = ({ instruction, setNewInstructions }: NewInstructionFieldProps) => {
...
export const CreatePreparations = ({ instructions, iterationId, setNodes }: CreateInstructionProps) => {

  // form fields for new instructions
  const [newInstructions, setNewInstructions] = useState([{} as InstructionInput]);
