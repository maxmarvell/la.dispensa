...
// types
import { RecipeCardType, OnScreenProps } from "../../@types/dashboard";
...
export function useOnScreen({ infiniteScrollRef }: OnScreenProps) {
...
function RecipeCard({ recipe, last, hasNextPage, fetchNextPage }: RecipeCardType) {
