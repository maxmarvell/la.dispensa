...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'recipe' | 'ingredient' | 'connection' | 'recipeEditors' | 'rating' | 'review' | 'instruction' | 'timeAndTemperature' | 'recipeIngredient' | 'component' | 'iteration' | 'ingredientIteration' | 'instructionIteration' | 'timeAndTemperatureIteration'
  ...
  export interface IngredientIterationDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * const ingredientIterationWithIterationIdOnly = await prisma.ingredientIteration.findMany({ select: { iterationId: true } })
     * 
    **/
