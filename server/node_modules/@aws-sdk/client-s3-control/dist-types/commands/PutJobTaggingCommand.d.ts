...
declare const PutJobTaggingCommand_base: {
    new (input: PutJobTaggingCommandInput): import("@smithy/smithy-client").CommandImpl<PutJobTaggingCommandInput, PutJobTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
