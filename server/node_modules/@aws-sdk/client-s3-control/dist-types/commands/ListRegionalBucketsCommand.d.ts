...
declare const ListRegionalBucketsCommand_base: {
    new (input: ListRegionalBucketsCommandInput): import("@smithy/smithy-client").CommandImpl<ListRegionalBucketsCommandInput, ListRegionalBucketsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
