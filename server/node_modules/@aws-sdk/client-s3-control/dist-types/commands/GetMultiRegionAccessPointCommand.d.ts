...
declare const GetMultiRegionAccessPointCommand_base: {
    new (input: GetMultiRegionAccessPointCommandInput): import("@smithy/smithy-client").CommandImpl<GetMultiRegionAccessPointCommandInput, GetMultiRegionAccessPointCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
