...
declare const GetStorageLensConfigurationTaggingCommand_base: {
    new (input: GetStorageLensConfigurationTaggingCommandInput): import("@smithy/smithy-client").CommandImpl<GetStorageLensConfigurationTaggingCommandInput, GetStorageLensConfigurationTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
