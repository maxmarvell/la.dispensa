...
declare const GetStorageLensGroupCommand_base: {
    new (input: GetStorageLensGroupCommandInput): import("@smithy/smithy-client").CommandImpl<GetStorageLensGroupCommandInput, GetStorageLensGroupCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
