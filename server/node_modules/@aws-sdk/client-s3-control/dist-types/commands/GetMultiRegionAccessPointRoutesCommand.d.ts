...
declare const GetMultiRegionAccessPointRoutesCommand_base: {
    new (input: GetMultiRegionAccessPointRoutesCommandInput): import("@smithy/smithy-client").CommandImpl<GetMultiRegionAccessPointRoutesCommandInput, GetMultiRegionAccessPointRoutesCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
