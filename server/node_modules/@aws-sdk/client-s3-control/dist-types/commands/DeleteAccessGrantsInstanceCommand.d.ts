...
declare const DeleteAccessGrantsInstanceCommand_base: {
    new (input: DeleteAccessGrantsInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAccessGrantsInstanceCommandInput, DeleteAccessGrantsInstanceCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
