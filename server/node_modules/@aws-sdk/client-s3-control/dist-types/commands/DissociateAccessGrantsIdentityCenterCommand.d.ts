...
declare const DissociateAccessGrantsIdentityCenterCommand_base: {
    new (input: DissociateAccessGrantsIdentityCenterCommandInput): import("@smithy/smithy-client").CommandImpl<DissociateAccessGrantsIdentityCenterCommandInput, DissociateAccessGrantsIdentityCenterCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
