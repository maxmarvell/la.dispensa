...
declare const ListStorageLensGroupsCommand_base: {
    new (input: ListStorageLensGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListStorageLensGroupsCommandInput, ListStorageLensGroupsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
