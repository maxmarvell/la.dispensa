...
declare const PutStorageLensConfigurationTaggingCommand_base: {
    new (input: PutStorageLensConfigurationTaggingCommandInput): import("@smithy/smithy-client").CommandImpl<PutStorageLensConfigurationTaggingCommandInput, PutStorageLensConfigurationTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
