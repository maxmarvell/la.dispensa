...
declare const CreateAccessGrantsInstanceCommand_base: {
    new (input: CreateAccessGrantsInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAccessGrantsInstanceCommandInput, CreateAccessGrantsInstanceCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
