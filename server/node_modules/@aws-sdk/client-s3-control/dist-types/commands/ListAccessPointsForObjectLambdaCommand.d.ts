...
declare const ListAccessPointsForObjectLambdaCommand_base: {
    new (input: ListAccessPointsForObjectLambdaCommandInput): import("@smithy/smithy-client").CommandImpl<ListAccessPointsForObjectLambdaCommandInput, ListAccessPointsForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
