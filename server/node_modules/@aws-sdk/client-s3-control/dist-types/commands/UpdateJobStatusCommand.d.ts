...
declare const UpdateJobStatusCommand_base: {
    new (input: UpdateJobStatusCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateJobStatusCommandInput, UpdateJobStatusCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
