...
declare const GetStorageLensConfigurationCommand_base: {
    new (input: GetStorageLensConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetStorageLensConfigurationCommandInput, GetStorageLensConfigurationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
