...
declare const GetMultiRegionAccessPointPolicyCommand_base: {
    new (input: GetMultiRegionAccessPointPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<GetMultiRegionAccessPointPolicyCommandInput, GetMultiRegionAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
