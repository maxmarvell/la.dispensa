...
declare const UpdateJobPriorityCommand_base: {
    new (input: UpdateJobPriorityCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateJobPriorityCommandInput, UpdateJobPriorityCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
