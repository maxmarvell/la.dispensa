...
declare const PutStorageLensConfigurationCommand_base: {
    new (input: PutStorageLensConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutStorageLensConfigurationCommandInput, PutStorageLensConfigurationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
