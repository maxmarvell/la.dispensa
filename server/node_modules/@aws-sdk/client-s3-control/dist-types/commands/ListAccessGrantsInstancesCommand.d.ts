...
declare const ListAccessGrantsInstancesCommand_base: {
    new (input: ListAccessGrantsInstancesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAccessGrantsInstancesCommandInput, ListAccessGrantsInstancesCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
