...
declare const SubmitMultiRegionAccessPointRoutesCommand_base: {
    new (input: SubmitMultiRegionAccessPointRoutesCommandInput): import("@smithy/smithy-client").CommandImpl<SubmitMultiRegionAccessPointRoutesCommandInput, SubmitMultiRegionAccessPointRoutesCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
