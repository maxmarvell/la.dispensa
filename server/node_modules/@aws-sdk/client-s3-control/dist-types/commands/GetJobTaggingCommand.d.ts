...
declare const GetJobTaggingCommand_base: {
    new (input: GetJobTaggingCommandInput): import("@smithy/smithy-client").CommandImpl<GetJobTaggingCommandInput, GetJobTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
