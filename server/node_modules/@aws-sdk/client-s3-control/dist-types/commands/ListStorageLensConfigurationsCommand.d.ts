...
declare const ListStorageLensConfigurationsCommand_base: {
    new (input: ListStorageLensConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListStorageLensConfigurationsCommandInput, ListStorageLensConfigurationsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
