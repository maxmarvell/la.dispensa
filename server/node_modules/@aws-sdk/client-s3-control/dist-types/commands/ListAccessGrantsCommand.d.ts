...
declare const ListAccessGrantsCommand_base: {
    new (input: ListAccessGrantsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAccessGrantsCommandInput, ListAccessGrantsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
