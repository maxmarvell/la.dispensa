...
declare const ListAccessPointsCommand_base: {
    new (input: ListAccessPointsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAccessPointsCommandInput, ListAccessPointsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
