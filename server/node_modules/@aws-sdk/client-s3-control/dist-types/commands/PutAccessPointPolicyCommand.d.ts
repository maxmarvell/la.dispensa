...
declare const PutAccessPointPolicyCommand_base: {
    new (input: PutAccessPointPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutAccessPointPolicyCommandInput, PutAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
