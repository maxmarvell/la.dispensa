...
declare const PutMultiRegionAccessPointPolicyCommand_base: {
    new (input: PutMultiRegionAccessPointPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutMultiRegionAccessPointPolicyCommandInput, PutMultiRegionAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
