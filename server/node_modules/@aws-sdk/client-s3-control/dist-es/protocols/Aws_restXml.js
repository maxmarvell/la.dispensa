...
export const de_UpdateJobPriorityCommand = async (output, context) => {
    ...
    if (data[_Pr] != null) {
        contents[_Pr] = __strictParseInt32(data[_Pr]);
    }
    return contents;
};
...
const se_KeyNameConstraint = (input, context) => {
    ...
    bn.lc(input, "MatchAnySubstring", "MatchAnySubstring", () => se_NonEmptyMaxLength1024StringList(input[_MASa], context));
    return bn;
};
...
const se_ObjectLambdaConfiguration = (input, context) => {
    ...
    bn.lc(input, "TransformationConfigurations", "TransformationConfigurations", () => se_ObjectLambdaTransformationConfigurationsList(input[_TC], context));
    return bn;
};
...
const se_ObjectLambdaTransformationConfiguration = (input, context) => {
    ...
    bn.lc(input, "Actions", "Actions", () => se_ObjectLambdaTransformationConfigurationActionsList(input[_Act], context));
    if (input[_CTo] != null) {
...
const de_JobManifestGeneratorFilter = (output, context) => {
    ...
    if (output[_OSGTB] != null) {
        contents[_OSGTB] = __strictParseLong(output[_OSGTB]);
    }
...
const de_JobProgressSummary = (output, context) => {
    ...
    if (output[_TNOT] != null) {
        contents[_TNOT] = __strictParseLong(output[_TNOT]);
    }
    if (output[_NOTS] != null) {
        contents[_NOTS] = __strictParseLong(output[_NOTS]);
    }
    if (output[_NOTF] != null) {
        contents[_NOTF] = __strictParseLong(output[_NOTF]);
    }
    if (output[_Tim] != null) {
...
const de_JobTimers = (output, context) => {
    ...
    if (output[_ETIAS] != null) {
        contents[_ETIAS] = __strictParseLong(output[_ETIAS]);
    }
    return contents;
};
...
const de_LifecycleExpiration = (output, context) => {
    ...
    if (output[_Day] != null) {
        contents[_Day] = __strictParseInt32(output[_Day]);
    }
...
const de_MatchObjectAge = (output, context) => {
    const contents = {};
    if (output[_DGT] != null) {
        contents[_DGT] = __strictParseInt32(output[_DGT]);
    }
    if (output[_DLT] != null) {
        contents[_DLT] = __strictParseInt32(output[_DLT]);
    }
    return contents;
};
const de_MatchObjectSize = (output, context) => {
    const contents = {};
    if (output[_BGT] != null) {
        contents[_BGT] = __strictParseLong(output[_BGT]);
    }
    if (output[_BLT] != null) {
        contents[_BLT] = __strictParseLong(output[_BLT]);
    }
    return contents;
};
...
const de_MultiRegionAccessPointRoute = (output, context) => {
    ...
    if (output[_TDP] != null) {
        contents[_TDP] = __strictParseInt32(output[_TDP]);
    }
    return contents;
};
...
const de_S3InitiateRestoreObjectOperation = (output, context) => {
    const contents = {};
    if (output[_EID] != null) {
        contents[_EID] = __strictParseInt32(output[_EID]);
    }
    if (output[_GJT] != null) {
...
const de_S3ObjectMetadata = (output, context) => {
    ...
    if (output[_CLo] != null) {
        contents[_CLo] = __strictParseLong(output[_CLo]);
    }
    if (output[_CMD] != null) {
...
const de_SelectionCriteria = (output, context) => {
    ...
    if (output[_MDa] != null) {
        contents[_MDa] = __strictParseInt32(output[_MDa]);
    }
    if (output[_MSBP] != null) {
        contents[_MSBP] = __strictParseFloat(output[_MSBP]);
    }
    return contents;
};
